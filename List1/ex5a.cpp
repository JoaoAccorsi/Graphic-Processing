...
int main()
{
	...
	GLFWwindow *window = glfwCreateWindow(WIDTH, HEIGHT, "Ex5 a -- João Accorsi", nullptr, nullptr);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glDrawArrays(GL_TRIANGLES, 0, 6); // número de vertices a serem processados
